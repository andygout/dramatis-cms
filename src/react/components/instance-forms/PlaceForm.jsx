...
import { useCreatePlaceMutation, useUpdatePlaceMutation, useDeletePlaceMutation } from '../../../redux/slices/api.js';
...
const PlaceForm = (props) => {
	...
	return (
		<FormWrapper
			...
			createInstance={createPlace}
			updateInstance={updatePlace}
			deleteInstance={deletePlace}
		>
