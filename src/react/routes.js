...
import { errorDeactivated } from '../redux/features/errorSlice.js';
import { notificationDeactivated } from '../redux/features/notificationSlice.js';
import { MODELS, PLURALISED_MODELS } from '../utils/constants.js';

const deactivateError = (dispatch, isErrorActive) => {
...
const deactivateNotification = (dispatch, isNotificationActive) => {
...
export default [
	...
	},
	{
		...
		component: Festival,
		fetchData: [
			dispatch => dispatch(fetchInstanceTemplate(MODELS.FESTIVAL))
		],
		deactivateError,
		deactivateNotification
	},
	...
	},
	{
		...
		fetchData: [
			dispatch => dispatch(fetchInstanceTemplate(MODELS.FESTIVAL_SERIES))
		],
		deactivateError,
		deactivateNotification
	},
